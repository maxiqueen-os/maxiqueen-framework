...
export default function ChatPage() {
  ...
  // Puente de voz con la página padre
  useEffect(() => {
    const handler = (e: MessageEvent) => {
      if (e.data?.type === 'MQ_VOICE') {
        ...
        if (e.data.action === 'speak') {
          ...
          if (last) { setVoiceEnabled(true); setTimeout(() => speak(last.content), 50); }
        }
      }
    };
    ...
    <div style={{ minHeight: '100vh', background: '#0a0a0a', color: '#e5e5e5', fontFamily: 'system-ui, Inter, sans-serif' }}>
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '40px 20px' }}>
        ...
        <div style={{ background: '#141414', border: '1px solid #262626', borderRadius: 16, padding: 20, minHeight: 420 }}>
          ...
          <div style={{ display: 'flex', gap: 12, marginTop: 14, fontSize: 13, color: '#9ca3af', alignItems: 'center', flexWrap: 'wrap' }}>
